...
import { getInvites, updateInvite, deleteInvite } from '../../../services/inviteServices';
  ...
  if (!loading) {
    return (
      <div style={{ width: '80vw', marginTop: '50px' }}>
        <Typography variant="h5" sx={{ marginBottom: '20px' }}>Invitations</Typography>
        <MaterialReactTable
          columns={columns}
          data={data}
